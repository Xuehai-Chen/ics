...
make_group(gp7,
	...
	opcode_entry opcode_table [512] = {
		...
		/* 0x08 */	IDEXW(E2G,or,1), IDEX(E2G,or), IDEX(E2G,or), EMPTY,
		/* 0x0c */	EMPTY, EMPTY, EMPTY, EX(2byte_esc),
		/* 0x10 */	EMPTY, EMPTY, IDEXW(E2G,adc,1), IDEX(E2G,adc),
		...
		/* 0x84 */	IDEX(G2E,test), IDEX(E2G,test), EMPTY, EMPTY,
		...
		/* 0xb4 */	EMPTY, EMPTY, IDEXW(G2E,movzx,1), IDEXW(E2G,movzx,2),
